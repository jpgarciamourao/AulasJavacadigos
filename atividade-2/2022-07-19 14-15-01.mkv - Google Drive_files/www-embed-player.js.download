...
b=nl("//googleads.g.doubleclick.net/pagead/id",a)})).gb(function(c){c instanceof Ef&&b.abort();
return Cf(c)})}
...
try{Gv("//static.doubleclick.net/instream/ad_status.js",b)}catch(c){}Nv.push(Wh.S(function(){if(!(Ov||"google_ad_status"in window)){try{Mv("//static.doubleclick.net/instream/ad_status.js",b)}catch(c){}Ov=!0;Ek("DCLKSTAT",3)}},5E3))}}}
...
L("PL_ATT")&&Xv.dispose();for(var a=Wh,b=0,c=Nv.length;b<c;b++)a.fa(Nv[b]);Nv.length=0;Lv("//static.doubleclick.net/instream/ad_status.js");Ov=!1;Ek("DCLKSTAT",0);pe(jx,ix);hx&&(hx.removeEventListener("onVideoDataChange",kx),hx.destroy())});
